...
@section('page-title', 'Facturas Emitidas')
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Facturas Emitidas</h2>
            <p class="mt-1 text-sm text-gray-600">Gestiona todas las facturas de venta emitidas</p>
        </div>
        <x-button-link href="{{ route('facturas.crear') }}" variant="primary">
    ...
    <!-- Filtros y Búsqueda -->
    <x-card>
        <form method="GET" action="{{ route('facturas.index') }}" class="space-y-4">
                ...
                @forelse($facturas as $factura)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                            ...
                            @if($factura->estado === 'PENDIENTE')
                                <form
                                    action="{{ route('facturas.marcar-pagada', $factura) }}"
                                    method="POST"
                                    class="inline"
                            ...
                            @if($factura->estado !== 'ANULADA')
                                <form
                                    action="{{ route('facturas.anular', $factura) }}"
                                    method="POST"
                                    class="inline"
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center">
                            ...
                            <div class="mt-6">
                                <a href="{{ route('facturas.crear') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
